...
- We recommend the tidyverse [style guide](http://style.tidyverse.org).
  ...
  package or the [Air
  formatter](https://posit-dev.github.io/air/formatter.html) to apply
...
- For user-facing changes, add a bullet to the top of `NEWS.md` below
  ...
  followed by your username, and links to relevant issue(s)/PR(s).
...
See rOpenSci [contributing
guide](https://ropensci.github.io/dev_guide/contributingguide.html) for
further details.
