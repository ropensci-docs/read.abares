...
control the behaviour of the package. These options can be set using the
...
on, for instance, the GitHub usernames of the developers)”[^1]. You can
change the user agent string using the `user_agent` argument in the
[`read.abares_options()`](https://docs.ropensci.org/read.abares/reference/read.abares_options.md):
...
- “verbose” (provides download status bars, file import messages and
  more),
- “default” (provides warning messages and error messages),
...
read.abares_options(verbosity = "default")
# or
read.abares_options(verbosity = "quiet")
```

[^1]: rOpenSci Developers’ Guide:
    <https://devguide.ropensci.org/pkg_building.html#packages-wrapping-web-resources-api-clients>
